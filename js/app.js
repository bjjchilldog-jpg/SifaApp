// --- GLOBAL VARIABLES ---
    ...
    const allModules = [
        ...
        { id: 'view-5', title: '4. Prüffristen-Kataster', icon: 'fa-calendar-check', mode: 'sifa' },
        { id: 'view-6', title: '5. IT-Infrastruktur', icon: 'fa-server', mode: 'sifa' },
        { id: 'view-12', title: '6. Zwiebelschale', icon: 'fa-layer-group', mode: 'sifa' },
        { id: 'view-equipment', title: '7. Geräte/Maschinen', icon: 'fa-plug', mode: 'sifa' },
        { id: 'view-3', title: '8. Begehung & Mängel', icon: 'fa-camera', mode: 'both' },
